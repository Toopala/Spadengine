...
namespace sge
{
	...
	public:
        ...
        RenderTarget* createRenderTarget(size_t count, size_t width, size_t height, bool depth = false);
        RenderTarget* createDeferredRenderTarget(size_t width, size_t height, bool depth = false);
