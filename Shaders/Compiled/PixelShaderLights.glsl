...
void main()
{
    ...
    while(true){
        ...
        Temp[6].xyz = Input5.xyz * UniformDataPS.pointLights.position[floatBitsToInt(Temp[1]).w].xyzx.yyy;
        Temp[6].xyz = Input4.xyz * UniformDataPS.pointLights.position[floatBitsToInt(Temp[1]).w].xyzx.xxx + Temp[6].xyz;
        Temp[6].xyz = Input6.xyz * UniformDataPS.pointLights.position[floatBitsToInt(Temp[1]).w].xyzx.zzz + Temp[6].xyz;
