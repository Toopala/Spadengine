...
void main()
{
    ...
    Temp[1].xyz = Input5.xyz * UniformDataPS.viewPos.xyzx.yyy;
    Temp[1].xyz = Input4.xyz * UniformDataPS.viewPos.xyzx.xxx + Temp[1].xyz;
    Temp[1].xyz = Input6.xyz * UniformDataPS.viewPos.xyzx.zzz + Temp[1].xyz;
    ...
    while(true){
        ...
        Temp[10].xyz = Temp[6].yyy * Input5.xyz;
        Temp[6].xyw = Input4.xyz * Temp[6].xxx + Temp[10].xyz;
